...
/* ── Aceternity Spotlight (SVG-based, for hero backgrounds) ── */
...
export const Spotlight = ({ className, fill }: AceternitySpotlightProps) => {
  return (
    <svg
      className={cn(
...
/* ── Ibelick Spotlight (interactive mouse-following, for cards) ── */
